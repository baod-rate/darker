...
try:
    ...
    if flynt_version < (1, 0, 0):
        from flynt.process import fstringify_code_by_line as flynt_fstringify_code_by_line
        from flynt.pyproject_finder import find_pyproject_toml
        from flynt.pyproject_finder import parse_pyproject_toml
    else:
        from flynt.code_editor import fstringify_code_by_line as flynt_fstringify_code_by_line
        from flynt.utils.pyproject_finder import find_pyproject_toml
        from flynt.utils.pyproject_finder import parse_pyproject_toml
except ImportError:
